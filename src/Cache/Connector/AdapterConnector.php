...
namespace Khachik\Flysystem\Cache\Connector;

use Khachik\Flysystem\FlysystemManager;
...
final class AdapterConnector implements ConnectorInterface
{
     ...
     *
     * @var \Khachik\Flysystem\FlysystemManager
     */
    private $manager;
     ...
     *
     * @return \Khachik\Flysystem\FlysystemManager
     */
